...
<body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li><a href="../account/addaccount.php"><em class="fa fa-toggle-off">&nbsp;</em> Add Account</a></li>
            <li class="active"><a href="addsupplier.php"><em class="fa fa-clone">&nbsp;</em> Add Supplier </a></li>
