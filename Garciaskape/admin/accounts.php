					...
					?>
                            <tr>
                                ...
                                <td> <?php  
                                        $status = $row["status"];
                                        if ($status == 'Active') {
                                            echo '<button type="button" class="btn btn-danger" id="deactive_button">Deactivate </button>';
                                            
                                        } else {
                                            echo '<button type="button" class="btn btn-success" id="activate_button" >Activate</button>';  
