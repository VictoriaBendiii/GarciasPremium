                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xs-offset-3">
                    <form id="contact-form" class="form" action="adduser.php" method="POST" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <span id="popover-cnumber" class="hide pull-right block-help"><i class="fa fa-info-circle text-danger" aria-hidden="true"></i> Enter 13 digit phone number </span>
                            <div class="input-group">
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-secondary" disabled>+63</button>
                                </span>
                                <input type="text" class="form-control" id="contact_number" name="contact_number" minlength="10" maxlength="10" placeholder="9XXXXXXXXX" required>
                            </div>
                        </div>
                            <div class="form-group">
                            ...
                            <div class="text-center">
                                <button type="submit" id="submit" class="btn btn-start-order" name="add_user" id="add_user">Submit</button>
                            </div>
                    </form>
                    </div>
