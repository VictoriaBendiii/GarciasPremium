    ...
    <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="btn-group" style="width:100%">
                ...
                <button onclick="location.href='delivered_filter_report_m.php'" style="width:33.3%">Filter</button>
            </div>
            <br>
            <div class="btn-group" style="width:100%">
                <button onclick="location.href='ordered_report_m.php'" style="width:33.3%">Ordered Report</button>
                <button class="btn btn-primary active" onclick="location.href='delivered_report_m.php'" style="width:33.3%">Delivery Report</button>
