...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="../product/addproduct.php"><em class="fa fa-toggle-off">&nbsp;</em> Products</a></li>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xs-offset-3">
                    <form id="contact-form" class="form" action="addprod.php" method="POST" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="prodname" value="Market and Porta"
                                tabindex="1" readonly>
                        </div>
