...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 16, 2019 at 02:33 PM
...
INSERT INTO `accounts` (`accountid`, `username`, `email`, `password`, `user_type`, `firstname`, `middlename`, `lastname`, `contact_number`, `status`) VALUES
(1, 'admin', 'eliangel77@gmail.com', 'admin', 'admin', 'Eli', 'Angel', 'Garcia', '091777777', 'active'),
(2, 'subadmin1', 'bendi9@gmail.com', 'subadmin1', 'sub-admin1', 'Victoria Bendi', 'Olarte', 'Buse', '091888888', 'active'),
(3, 'subadmin2', 'steven10@gmail.com', 'subadmin2', 'sub-admin2', 'Steven', 'Barry', 'Mangati', '091999999', 'active');
...
(13, 10, 29, 6, 200.00, NULL, 6, 3, 2, 1, '2019-03-05 05:00:00', 'rejected'),
(22, 11, 1, 1, 1.00, 11, NULL, NULL, 1, 1, '2019-04-16 08:54:22', 'sold');
...
(3, 'Market', 'Eli', '09155667788', 'Public Market Baguio City');
COMMIT;
